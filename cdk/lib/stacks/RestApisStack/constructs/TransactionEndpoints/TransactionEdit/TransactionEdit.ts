...
export class TransactionEdit extends Construct {
    ...
    constructor(scope: Construct, id: string, private props: {
        ...
        const fn = new LambdaTypescript(this, 'LambdaTypescript', {
            entry: path.resolve(__dirname, 'TransactionEdit.lambda.ts'),
        });
        props.rootResource.resourceForPath('transaction/{id}').addMethod('PUT', new LambdaIntegration(fn), {
