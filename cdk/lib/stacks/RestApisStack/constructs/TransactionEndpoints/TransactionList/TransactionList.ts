...
export class TransactionList extends Construct {
    ...
    constructor(scope: Construct, id: string, private props: {
        ...
        const fn = new LambdaTypescript(this, 'LambdaTypescript', {
            entry: path.resolve(__dirname, 'TransactionList.lambda.ts'),
        });
        props.rootResource.resourceForPath('transaction').addMethod('GET', new LambdaIntegration(fn), {
