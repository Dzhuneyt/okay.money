...
export class CategoryCreate extends Construct {
    ...
    constructor(scope: Construct, id: string, private props: {
        ...
        const fn = new LambdaTypescript(this, 'LambdaTypescript', {
            entry: path.resolve(__dirname, 'CategoryCreate.lambda.ts'),
        });
        props.rootResource.resourceForPath('category').addMethod('POST', new LambdaIntegration(fn), {
