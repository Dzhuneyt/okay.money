...
export class GoogleSsoFinish extends Construct {
    ...
    constructor(scope: Construct, id: string, private props: {
        ...
        const fn = new LambdaTypescript(this, 'LambdaTypescript', {
            entry: path.resolve(__dirname, 'GoogleSsoFinish.lambda.ts'),
            environment: {
        ...
        props.tableForTemporaryDestinations.grantReadData(fn);

        props.rootResource
            .resourceForPath('auth/sso/google/finish')
